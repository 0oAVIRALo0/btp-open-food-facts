...
import {Box, Container, Autocomplete, Tab, Tabs, Checkbox, FormControl, FormControlLabel, FormGroup, Button, FormHelperText, InputLabel, TextField} from "@mui/material";
          ...
          {value == 1 ? (
            <span>
              ...
              >
                <div className="form__wrapper">
                  <div>
                    <InputLabel style={{color: "#e69c52"}} htmlFor="input-protein">Macro Class</InputLabel>
                    <div
                      style={{
                        display: "flex",
                        alignItems: "center",
                ...
                <div className="form__wrapper">
                  <div>
                  <InputLabel style={{color: "#e69c52"}} htmlFor="input-protein">
                      Category Name
                    </InputLabel>
                    <div
                      style={{
